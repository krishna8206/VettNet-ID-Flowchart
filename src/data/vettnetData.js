...
export const VETTNET_DATA = {
  ...
  // 6 Interactive Visual Pipelines with Symmetrically Balanced Coordinates (Trunk center = 780)
  flowcharts: {
    masterArchitecture: {
      ...
      nodes: [
        ...
        { id: "m2", stepNum: "02", stage: "Stage 02", title: "VettNet ID / VN Number", subtitle: "Unique Master Index Reference Key", secId: "sec-4", type: "process", x: 600, y: 220, icon: "Fingerprint" },
        { id: "m3", stepNum: "03", stage: "Stage 03", title: "Identity Authentication", subtitle: "Level-1 Existence Verification", secId: "sec-19", type: "process", x: 600, y: 400, icon: "ShieldCheck" },
        { id: "m4", stepNum: "04", stage: "Stage 04", title: "Consent & Purpose Layer", subtitle: "5-Point Gate & Attribute Scoping", secId: "sec-8", type: "gate", x: 600, y: 580, icon: "Lock" },
        { id: "m5", stepNum: "05", stage: "Stage 05", title: "Profile Modules (15)", subtitle: "Modular Data Structures & Stores", secId: "sec-10", type: "subflow", x: 600, y: 760, icon: "Layers" },
        { id: "m6", stepNum: "06", stage: "Stage 06", title: "Evidence Management", subtitle: "9-Field Provenance & Document Hashing", secId: "sec-11", type: "process", x: 600, y: 940, icon: "FileText" },
        { id: "m7", stepNum: "07", stage: "Stage 07", title: "Gov & External API Gateway", subtitle: "Secure DMZ Connector Layer", secId: "sec-20", type: "gateway", x: 600, y: 1120, icon: "Cpu" },
        
        // 4 Statutory Gateways Symmetrically Balanced (Span: 60 to 1560, Center = 780)
        { id: "m7_dha", stepNum: "07a", stage: "Statutory API", title: "DHA Connector", subtitle: "National Population Register (IDs, Passports, Visas)", secId: "sec-21", type: "connector", x: 60, y: 1320, icon: "Landmark" },
        { id: "m7_sars", stepNum: "07b", stage: "Statutory API", title: "SARS Connector", subtitle: "Tax PIN & Corporate Compliance Status", secId: "sec-22", type: "connector", x: 440, y: 1320, icon: "DollarSign" },
        { id: "m7_cipc", stepNum: "07c", stage: "Statutory API", title: "CIPC Connector", subtitle: "Company Registry, Directors & UBO Graph", secId: "sec-12", type: "connector", x: 820, y: 1320, icon: "Briefcase" },
        { id: "m7_other", stepNum: "07d", stage: "Statutory API", title: "SAQA / CIDB / Others", subtitle: "National Academic DB & Council Accreditations", secId: "sec-12", type: "connector", x: 1200, y: 1320, icon: "Award" },
        
        // Verification & Processing Engines
        { id: "m8", stepNum: "08", stage: "Stage 08", title: "Verification Engine", subtitle: "7-Stage Processing & Status Determination", secId: "sec-14", type: "process", x: 600, y: 1540, icon: "CheckCircle2" },
        { id: "m9", stepNum: "09", stage: "Stage 09", title: "Trust & Risk Engine", subtitle: "Anomaly, Conflict & Expiry Analysis", secId: "sec-16", type: "engine", x: 600, y: 1720, icon: "AlertTriangle" },
        { id: "m10", stepNum: "10", stage: "Stage 10", title: "Verified Digital Profile", subtitle: "Cryptographically Sealed Reusable Asset", secId: "sec-45", type: "verified", x: 600, y: 1900, icon: "BadgeCheck" },
        { id: "m11", stepNum: "11", stage: "Stage 11", title: "Authorized Use & Sharing", subtitle: "Consent-Scoped Secure Data Reuse", secId: "sec-37", type: "process", x: 600, y: 2080, icon: "Share2" },
        { id: "m12", stepNum: "12", stage: "Stage 12", title: "Continuous Monitoring", subtitle: "Background Time-Sensitive Watch", secId: "sec-18", type: "monitoring", x: 600, y: 2260, icon: "Activity" },
        { id: "m13", stepNum: "13", stage: "Stage 13", title: "Automated Reverification", subtitle: "Scheduled Renewal & API Re-polling", secId: "sec-18", type: "reverification", x: 600, y: 2440, icon: "RefreshCw" },
        { id: "m14", stepNum: "14", stage: "Stage 14", title: "Immutable Audit Log", subtitle: "6W+P Tamper-Resistant Ledger", secId: "sec-31", type: "audit", x: 600, y: 2620, icon: "Archive" }
      ],
      connections: [
    ...
    individualFlow: {
      ...
      nodes: [
        ...
        { id: "ind_2", stepNum: "02", stage: "Step 02", title: "2. Identity Authentication", subtitle: "Level-1 Biometric / SA ID Match", secId: "sec-19", type: "process", x: 600, y: 260, icon: "ShieldCheck" },
        { id: "ind_3", stepNum: "03", stage: "Step 03", title: "3. Universal VN ID Generated", subtitle: "Unique VN Number Assigned (VN-XXXXXX)", secId: "sec-4", type: "verified", x: 600, y: 480, icon: "Hash" },
        { id: "ind_4", stepNum: "04", stage: "Step 04", title: "4. Add Profile Information", subtitle: "Academic, Professional, Family, Address", secId: "sec-5", type: "process", x: 600, y: 700, icon: "Edit3" },
        { id: "ind_5", stepNum: "05", stage: "Step 05", title: "5. Upload Evidence", subtitle: "Degrees, Reference Letters, ID Docs", secId: "sec-11", type: "process", x: 600, y: 920, icon: "UploadCloud" },
        { id: "ind_6", stepNum: "06", stage: "Step 06", title: "6. Verification Pipeline", subtitle: "API Checks & Officer Verification", secId: "sec-14", type: "gateway", x: 600, y: 1140, icon: "CheckCircle2" },
        { id: "ind_7", stepNum: "07", stage: "Step 07", title: "7. Trust & Risk Assessment", subtitle: "Conflict, Expiry & Duplicate Detection", secId: "sec-16", type: "engine", x: 600, y: 1360, icon: "AlertTriangle" },
        { id: "ind_8", stepNum: "08", stage: "Step 08", title: "8. Verified Digital Profile", subtitle: "Profile becomes Reusable Trust Asset", secId: "sec-45", type: "verified", x: 600, y: 1580, icon: "BadgeCheck" },
        { id: "ind_9", stepNum: "09", stage: "Step 09", title: "9. Consent-Based Sharing", subtitle: "Share Scoped Access with Employers/Orgs", secId: "sec-8", type: "process", x: 600, y: 1800, icon: "Share2" },
        { id: "ind_10", stepNum: "10", stage: "Step 10", title: "10. Continuous Monitoring", subtitle: "Track Expiries (Licenses, Visas, Permits)", secId: "sec-18", type: "monitoring", x: 600, y: 2020, icon: "Activity" },
        { id: "ind_11", stepNum: "11", stage: "Step 11", title: "11. Reverification", subtitle: "Scheduled or Triggered Re-Checks", secId: "sec-18", type: "reverification", x: 600, y: 2240, icon: "RefreshCw" }
      ],
      connections: [
    ...
    corporateFlow: {
      ...
      nodes: [
        ...
        { id: "corp_2", stepNum: "02", stage: "Step 02", title: "2. Submit Documents", subtitle: "Cert of Incorporation, Tax PIN, Director IDs", secId: "sec-34", type: "process", x: 600, y: 260, icon: "FileText" },
        { id: "corp_3", stepNum: "03", stage: "Step 03", title: "3. VettNet Review & Audit", subtitle: "Officer Review & CIPC/SARS Gateway Checks", secId: "sec-34", type: "process", x: 600, y: 480, icon: "Search" },
        { id: "corp_4", stepNum: "04", stage: "Step 04", title: "4. Approval Decision Gate", subtitle: "Approve / Reject / Correction Required", secId: "sec-34", type: "gate", x: 600, y: 700, icon: "GitBranch" },
        { id: "corp_5", stepNum: "05", stage: "Step 05", title: "5. Subscription Activation", subtitle: "Plan Tier, Seats, Search & Verification Quotas", secId: "sec-35", type: "process", x: 600, y: 920, icon: "CreditCard" },
        { id: "corp_6", stepNum: "06", stage: "Step 06", title: "6. Provision Team Users", subtitle: "Org Admin -> HR Manager -> Recruitment Officer", secId: "sec-36", type: "process", x: 600, y: 1140, icon: "Users" },
        { id: "corp_7", stepNum: "07", stage: "Step 07", title: "7. Purpose & Request Consent", subtitle: "e.g. Purpose: Employment Verification", secId: "sec-8", type: "gate", x: 600, y: 1360, icon: "Target" },
        { id: "corp_8", stepNum: "08", stage: "Step 08", title: "8. 6-Gate VettNet ID Search", subtitle: "Validate Org, Sub, Perms, Purpose, Consent, Scope", secId: "sec-37", type: "gateway", x: 600, y: 1580, icon: "Filter" },
        { id: "corp_9", stepNum: "09", stage: "Step 09", title: "9. Access Scoped Verified Data", subtitle: "Education, Employment, Licenses (Restricted Masked)", secId: "sec-8", type: "verified", x: 600, y: 1800, icon: "Eye" },
        { id: "corp_10", stepNum: "10", stage: "Step 10", title: "10. Immutable Audit Entry", subtitle: "Logged with 6W+P Schema for Traceability", secId: "sec-31", type: "audit", x: 600, y: 2020, icon: "Archive" }
      ],
      connections: [
    ...
    consentGatewayFlow: {
      ...
      nodes: [
        { id: "cg_1", stepNum: "01", stage: "Step 01", title: "1. Org Requests Access", subtitle: "Target VettNet ID: VN123456", secId: "sec-8", type: "start", x: 600, y: 40, icon: "Search" },
        { id: "cg_2", stepNum: "02", stage: "Step 02", title: "2. Purpose Selection Gate", subtitle: "Q1 & Q2: Who is requesting? Why is it required?", secId: "sec-8", type: "gate", x: 600, y: 260, icon: "HelpCircle" },
        { id: "cg_3", stepNum: "03", stage: "Step 03", title: "3. Authority & Consent Check", subtitle: "Q3: Does requester have valid consent token?", secId: "sec-8", type: "gate", x: 600, y: 480, icon: "Key" },
        { id: "cg_4", stepNum: "04", stage: "Step 04", title: "4. Permission & Scoping", subtitle: "Q4: What categories are authorized?", secId: "sec-8", type: "process", x: 600, y: 700, icon: "Sliders" },
        { id: "cg_5", stepNum: "05", stage: "Step 05", title: "5. TTL Verification Gate", subtitle: "Q5: How long is permission valid?", secId: "sec-8", type: "gate", x: 600, y: 920, icon: "Clock" },
        
        // Symmetrical 2-Way Branching (Center = 780)
        { id: "cg_allowed", stepNum: "06a", stage: "Permitted Scope", title: "Approved Categories Exposed", subtitle: "Education, Employment, Certifications (Decrypted)", secId: "sec-8", type: "verified", x: 380, y: 1140, icon: "CheckCircle2" },
        { id: "cg_restricted", stepNum: "06b", stage: "Masked Scope", title: "Sensitive Categories Sealed", subtitle: "Family, Legal, Financial, Address (Redacted)", secId: "sec-8", type: "engine", x: 820, y: 1140, icon: "Lock" },
        
        { id: "cg_6", stepNum: "06", stage: "Step 06", title: "6. Access Granted & Delivered", subtitle: "Payload delivered to requester client", secId: "sec-9", type: "process", x: 600, y: 1360, icon: "Unlock" },
        { id: "cg_7", stepNum: "07", stage: "Step 07", title: "7. Audit Log Committed", subtitle: "WHO, WHAT, RECORD, WHEN, PERM, PURPOSE", secId: "sec-31", type: "audit", x: 600, y: 1580, icon: "Archive" },
        { id: "cg_8", stepNum: "08", stage: "Step 08", title: "8. Permission Expires / Revoked", subtitle: "Access terminates upon TTL or User Revoke", secId: "sec-40", type: "reverification", x: 600, y: 1800, icon: "XCircle" }
      ],
      connections: [
    ...
    verificationEngineFlow: {
      ...
      nodes: [
        ...
        { id: "ve_2", stepNum: "02", stage: "Step 02", title: "2. Evidence Collected & Hashed", subtitle: "9 Metadata Fields attached + SHA-256 Hash", secId: "sec-11", type: "process", x: 600, y: 260, icon: "FileText" },
        { id: "ve_3", stepNum: "03", stage: "Step 03", title: "3. Source Identified & Routed", subtitle: "Selects DHA, SARS, CIPC, SAQA, CIDB or Manual Queue", secId: "sec-12", type: "gateway", x: 600, y: 480, icon: "Shuffle" },
        
        // Symmetrical 2-Way Branching (Center = 780)
        { id: "ve_api", stepNum: "03a", stage: "Tier 1 API", title: "Tier 1: Direct API Connector", subtitle: "Automated real-time statutory gateway handshake", secId: "sec-20", type: "connector", x: 380, y: 700, icon: "Zap" },
        { id: "ve_manual", stepNum: "03b", stage: "Tier 2 Manual", title: "Tier 2: Authorized Review", subtitle: "Verification Officer inspects official register", secId: "sec-23", type: "process", x: 820, y: 700, icon: "UserCheck" },
        
        { id: "ve_4", stepNum: "04", stage: "Step 04", title: "4. Verification Executed", subtitle: "Checks What, Source, Method, Time, Verifier, Evidence", secId: "sec-13", type: "process", x: 600, y: 920, icon: "Cpu" },
        { id: "ve_5", stepNum: "05", stage: "Step 05", title: "5. 7-Tuple Record Created", subtitle: "What, Source, Method, When, Who, Evidence, Reverification Date", secId: "sec-13", type: "verified", x: 600, y: 1140, icon: "FileCheck" },
        { id: "ve_6", stepNum: "06", stage: "Step 06", title: "6. Risk Assessment Handoff", subtitle: "Checks conflicts, duplicates, expiries, anomalies", secId: "sec-16", type: "engine", x: 600, y: 1360, icon: "ShieldAlert" },
        { id: "ve_7", stepNum: "07", stage: "Step 07", title: "7. Status Determination", subtitle: "Verified | Failed | Pending | Reverification Required", secId: "sec-15", type: "gate", x: 600, y: 1580, icon: "Tag" },
        { id: "ve_8", stepNum: "08", stage: "Step 08", title: "8. Append to Historical Ledger", subtitle: "Immutable append-only record; no overwrite of history", secId: "sec-32", type: "audit", x: 600, y: 1800, icon: "Database" }
      ],
      connections: [
    ...
    rbacInternalFlow: {
      ...
      nodes: [
        ...
        { id: "rb_2", stepNum: "02", stage: "Step 02", title: "2. Create Internal Staff", subtitle: "Provision individual operator accounts (no shared logins)", secId: "sec-28", type: "process", x: 600, y: 260, icon: "UserPlus" },
        { id: "rb_3", stepNum: "03", stage: "Step 03", title: "3. Compose Role from 13 Perms", subtitle: "View, Search, Create, Edit, Verify, Approve, Override...", secId: "sec-29", type: "process", x: 600, y: 480, icon: "Sliders" },
        { id: "rb_4", stepNum: "04", stage: "Step 04", title: "4. Assign Staff Role", subtitle: "Viewer | Officer | Manager | Senior Officer | Custom", secId: "sec-28", type: "gate", x: 600, y: 700, icon: "Award" },
        { id: "rb_5", stepNum: "05", stage: "Step 05", title: "5. Staff Authenticates & Logs In", subtitle: "MFA & Session Governance", secId: "sec-42", type: "process", x: 600, y: 920, icon: "LogIn" },
        { id: "rb_6", stepNum: "06", stage: "Step 06", title: "6. Access Assigned Work Queue", subtitle: "Application Manager dispatches batches to Officers", secId: "sec-38", type: "process", x: 600, y: 1140, icon: "List" },
        { id: "rb_7", stepNum: "07", stage: "Step 07", title: "7. Process & Adjudicate", subtitle: "Verify | Reject | Request Correction", secId: "sec-42", type: "gateway", x: 600, y: 1360, icon: "CheckSquare" },
        
        // Symmetrical Escalation Branch (Center = 780)
        { id: "rb_override", stepNum: "07a", stage: "Senior Escalation", title: "Senior Override Branch", subtitle: "Requires Reason, User ID, Timestamp, Evidence Attachment", secId: "sec-30", type: "engine", x: 920, y: 1560, icon: "AlertOctagon" },
        { id: "rb_8", stepNum: "08", stage: "Step 08", title: "8. Tamper-Proof Audit Commit", subtitle: "Logged with 6W+P schema (Actor, Action, Record, Time)", secId: "sec-31", type: "audit", x: 600, y: 1760, icon: "Archive" }
      ],
      connections: [
